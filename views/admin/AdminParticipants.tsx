            ...
            return (
              <div key={p.id} className="p-6 space-y-4">
                ...
                <div className="pt-2 flex justify-end gap-2 border-t border-slate-50 dark:border-zinc-800/50">
                  ...
                  <button className="size-8 flex items-center justify-center text-slate-400 hover:text-blue-500 hover:bg-blue-50 rounded-lg transition-colors">
                    <span className="material-symbols-outlined text-lg">edit</span>
                  </button>
                  <button className="size-8 flex items-center justify-center text-slate-400 hover:text-red-500 hover:bg-red-50 rounded-lg transition-colors">
                    ...
                    <td className="py-4 px-4 sm:px-6">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          <p className="text-sm font-bold text-slate-900 dark:text-white truncate max-w-[120px] sm:max-w-none">{p.name}</p>
